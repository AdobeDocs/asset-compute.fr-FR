---
title: Tester et déboguer [!DNL Asset Compute Service] application personnalisée
description: Testez et déboguez [!DNL Asset Compute Service] application personnalisée.
